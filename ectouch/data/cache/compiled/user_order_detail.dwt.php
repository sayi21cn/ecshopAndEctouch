...
?>
    ...
    <p> <a href="<?php echo url('user/order_tracking', array('order_id'=>$this->_var['order']['order_id']));?>" type="button" class="btn btn-info ect-btn-info ect-colorf"><?php echo $this->_var['lang']['order_tracking']; ?></a> </p>
    <?php endif; ?> 
  </div>
 ...
 <?php if ($this->_var['allow_edit_surplus']): ?>
    ...
    <section class="order-detail-info ect-margin-tb" style="border-top:none; margin-top:0;">
        <ul><li> <b class="pull-left"> <?php echo $this->_var['lang']['use_more_surplus']; ?>：</b><span><input name="surplus" class="ect-padding-lr" type="text" size="8" value="0" /></span>
         ...
         <input type="submit" name="Submit" class="btn btn-info ect-btn-info ect-colorf" value="<?php echo $this->_var['lang']['button_submit']; ?><?php echo $this->_var['lang']['use_surplus']; ?>" />
